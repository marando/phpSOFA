...
trait iauApco13 {
  ...
  public static function Apco13($utc1, $utc2, $dut1, $elong, $phi, $hm, $xp,
          $yp, $phpa, $tc, $rh, $wl, iauASTROM &$astrom, &$eo) {
    ...
    IAU::Epv00($tt1, $tt2, $ehpv, $ebpv);

    /* Form the equinox based BPN matrix, IAU 2006/2000A. */
    IAU::Pnm06a($tt1, $tt2, $r);

    /* Extract CIP X,Y. */
    IAU::Bpn2xy($r, $x, $y);

    /* Obtain CIO locator s. */
    $s = IAU::S06($tt1, $tt2, $x, $y);
    ...
    IAU::Apco($tt1, $tt2, $ebpv, $ehpv[0], $x, $y, $s, $theta, $elong, $phi, $hm,
